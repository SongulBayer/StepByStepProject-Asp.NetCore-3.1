...
namespace StepByStepProject.Controllers
{
    public class KategoriController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,KategoriName")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,KategoriName")] Kategori kategori)
        {
            if (id != kategori.Id)
            {
                return NotFound();
